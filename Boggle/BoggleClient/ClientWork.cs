...
namespace BoggleClient
{
    ...
    public class Client
    {
        ...
        /// <summary>
        /// Indicates that the session is stopping.
        /// </summary>
        ...
        private void GameStarting(String startingInfo, Exception e, Object playerName)
        {
            if(startingInfo == null) {
                Terminate("lost connection to the server");
                CleanUpConnection();
                return;
            }
            ...
            StartGame(boggleBoard, opponentName);
        ...
        ///     Time update, Score update, EndGame, Terminate
        /// </summary>
        ...
        private void MessageReceived(String msg, Exception e, Object playerName)
        {
           ...
           if(msg.ToUpper().StartsWith("TIME ")){
                UpdateTime(msg.Substring(msg.IndexOf(' ')+1)); //+1 because there is an initial empty character at the start of our parsed string.
           }
               ...
               stopping = true;
                ParseEndGame(msg.Substring(msg.IndexOf(' ')+1));
                CleanUpConnection();
                return;
           }
